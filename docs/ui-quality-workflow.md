...
Use the project-local Impeccable skill in **Operate/refinement** mode as the primary craft process. Use the project-local Vercel Web Interface Guidelines as a supplemental technical checklist. The vendored revisions adopted with this policy are:

- `pbakaus/impeccable` at `cb56ed6c19a07329a9fa0cd4e657bee040156593`
- `vercel-labs/agent-skills` at `063bee94c3f4df8453406c830b0a7df0f2860278`
