export const EN_MESSAGES = {
  ...
  "builder.bulkAssumption": "Threats start with usage-backed items and abilities, no active Tera, max offense, and the selected environment. Click a Pokémon to edit its build.",
